    ...
    <div class="content-wrapper">
       ...
       <div class="card">
           <div class="card-header">
               <h4 class="text-center">View Order #LE{{ $order->id }}</h4>
           </div>
           <div class="card-body">
               ...
               <form action="{{ route('admin.order.charge',$order->id) }}" method="post" style="display: inline-block !important;">
                   @csrf

                   <label>Shipping Charge</label>
                   <input type="number" name="shipping_charge" value="{{ $order->shipping_charge }}"><br/>
                   <label>Custom Discount</label>
                   <input type="number" name="custom_discount" value="{{ $order->custom_discount }}"><br/>

                   <input type="submit" value="Update" class="btn btn-success">

                   <a href="{{ route('admin.order.invoice',$order->id) }}" class="btn btn-info ml-3">Generate Invoice</a>
